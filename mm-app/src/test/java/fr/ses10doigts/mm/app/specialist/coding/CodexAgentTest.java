...
/**
 * Tests unitaires rapides de {@link CodexAgent}.
 */
class CodexAgentTest {
    ...
    @Test
    @DisplayName("Construit les args Codex et mappe le rapport extrait")
    void execute_withResolvedBinary_runsCodexAndReturnsExtractedReport() {
        CodexAgent agent = new CodexAgent(runner, missionBriefBuilder, reportExtractor, properties);
